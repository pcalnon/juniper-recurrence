...
from juniper_recurrence.routers import crossval_router, dataset_router, model_router, predict_router, snapshots_router, training_router
...
def build_app(settings: Settings | None = None) -> FastAPI:
    ...
    application = create_app(
        ...
        version=__version__,
        routers=(training_router, predict_router, model_router, dataset_router, crossval_router, snapshots_router),
        lifespan=lifespan,
    )
