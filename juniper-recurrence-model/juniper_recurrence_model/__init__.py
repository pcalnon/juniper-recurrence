...
memory unit (:class:`VariableStepLMUMemory`) and the fixed-order LMU regressor
(:class:`LMURegressor`) implementing juniper-model-core's ``TrainableModel`` interface.
